...
public class StatsControllerV1 {
    ...
    public ApiResponseBody<SensorStatsResult> getSensorStatsById(@PathVariable UUID sensorId,
        ...
        SensorStatsRequest request = new SensorStatsRequest(sensorId, new TimeWindowRequest(from, to));
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "type", required = true, description = "sensor type"),
    ...
    public ApiResponseBody<GroupStatsResult> getGroupStats(@RequestParam String houseId,
                                                           @RequestParam String zone,
                                                           @RequestParam String type,
                                                           @RequestParam Instant from,
                                                           @RequestParam Instant to) {
        GroupStatsRequest request = new GroupStatsRequest(houseId, zone, type, new TimeWindowRequest(from, to));
