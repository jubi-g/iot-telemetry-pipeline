...
public class MinuteAggregateRepository implements com.itp.aggregate_service.repository.MinuteAggregateRepository {
    ...
    /** Batch aggregations (fewer round-trips than per-minute calls). */
    @Override
    public int[] upsertBatchAggregate(List<Instant> buckets) {
        // TODO: add batch aggregation
        return new int[0];
    }

    @Override
    public int[] upsertBatchGroupAggregate(List<Instant> buckets) {
        // TODO: add batch aggregation
        return new int[0];
    }
}
